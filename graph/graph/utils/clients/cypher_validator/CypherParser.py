...
class CypherParser(Parser):
    ...
    def oC_QueryOptions(self):
        ...
        try:
            ...
            while ((_la) & ~0x3F) == 0 and (
                (1 << _la) & ((1 << CypherParser.CYPHER) | (1 << CypherParser.EXPLAIN) | (1 << CypherParser.PROFILE))
            ) != 0:
                self.state = 308
        ...
        try:
            ...
            if la_ == 1:
                ...
                while (((_la - 64)) & ~0x3F) == 0 and (
                    (1 << (_la - 64))
                    & (
                        (1 << (CypherParser.LOAD - 64))
                        | (1 << (CypherParser.OPTIONAL - 64))
                        | (1 << (CypherParser.MATCH - 64))
                        | (1 << (CypherParser.UNWIND - 64))
                        | (1 << (CypherParser.CALL - 64))
                        | (1 << (CypherParser.START - 64))
                    )
                ) != 0:
                    self.state = 405
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    while (((_la - 55)) & ~0x3F) == 0 and (
                        (1 << (_la - 55))
                        & (
                            (1 << (CypherParser.CREATE - 55))
                            | (1 << (CypherParser.MERGE - 55))
                            | (1 << (CypherParser.SET - 55))
                            | (1 << (CypherParser.DETACH - 55))
                            | (1 << (CypherParser.DELETE - 55))
                            | (1 << (CypherParser.REMOVE - 55))
                            | (1 << (CypherParser.FOREACH - 55))
                        )
                    ) != 0:
                        self.state = 451
                        self.oC_UpdatingClause()
    ...
    def oC_ProjectionItems(self):
        ...
        try:
            ...
            if token in [CypherParser.T__9]:
                ...
                CypherParser.ALL,
                CypherParser.EXISTS,
                CypherParser.SHORTESTPATH,
                CypherParser.ALLSHORTESTPATHS,
                CypherParser.NOT,
                CypherParser.NULL,
                CypherParser.COUNT,
                CypherParser.CASE,
                ...
                if not (
                    (
                        ...
                        and (
                            (1 << (_la - 89))
                            & (
                                (1 << (CypherParser.ASCENDING - 89))
                                | (1 << (CypherParser.ASC - 89))
                                | (1 << (CypherParser.DESCENDING - 89))
                                | (1 << (CypherParser.DESC - 89))
                            )
                        )
                        != 0
                    )
    ...
    def oC_NodePattern(self):
        ...
        try:
            ...
            if (((_la - 110)) & ~0x3F) == 0 and (
                (1 << (_la - 110))
                & (
                    (1 << (CypherParser.COUNT - 110))
                    | (1 << (CypherParser.FILTER - 110))
                    | (1 << (CypherParser.EXTRACT - 110))
                    | (1 << (CypherParser.ANY - 110))
                    | (1 << (CypherParser.NONE - 110))
                    | (1 << (CypherParser.SINGLE - 110))
                    | (1 << (CypherParser.HexLetter - 110))
                    | (1 << (CypherParser.UnescapedSymbolicName - 110))
                    | (1 << (CypherParser.EscapedSymbolicName - 110))
                )
            ) != 0:
                self.state = 1243
                self.oC_Variable()
    ...
    def oC_RangeLiteral(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la - 124)) & ~0x3F) == 0 and (
                (1 << (_la - 124))
                & (
                    (1 << (CypherParser.HexInteger - 124))
                    | (1 << (CypherParser.DecimalInteger - 124))
                    | (1 << (CypherParser.OctalInteger - 124))
                )
            ) != 0:
                self.state = 1414
                self.oC_IntegerLiteral()
                ...
                if (
                    ...
                    and (
                        ...
                        & (
                            ...
                            | (1 << CypherParser.T__19)
                            | (1 << CypherParser.T__24)
                            | (1 << CypherParser.T__26)
                            | (1 << CypherParser.ALL)
                            | (1 << CypherParser.EXISTS)
                        )
                    )
                    != 0
                ) or (
                    ...
                    and (
                        (1 << (_la - 100))
                        & (
                            (1 << (CypherParser.SHORTESTPATH - 100))
                            | (1 << (CypherParser.ALLSHORTESTPATHS - 100))
                            | (1 << (CypherParser.NOT - 100))
                            | (1 << (CypherParser.NULL - 100))
                            | (1 << (CypherParser.COUNT - 100))
                            | (1 << (CypherParser.CASE - 100))
                            | (1 << (CypherParser.FILTER - 100))
                            | (1 << (CypherParser.EXTRACT - 100))
                            | (1 << (CypherParser.REDUCE - 100))
                            | (1 << (CypherParser.ANY - 100))
                            | (1 << (CypherParser.NONE - 100))
                            | (1 << (CypherParser.SINGLE - 100))
                            | (1 << (CypherParser.TRUE - 100))
                            | (1 << (CypherParser.FALSE - 100))
                            | (1 << (CypherParser.HexInteger - 100))
                            | (1 << (CypherParser.DecimalInteger - 100))
                            | (1 << (CypherParser.OctalInteger - 100))
                            | (1 << (CypherParser.HexLetter - 100))
                            | (1 << (CypherParser.ExponentDecimalReal - 100))
                            | (1 << (CypherParser.RegularDecimalReal - 100))
                            | (1 << (CypherParser.StringLiteral - 100))
                            | (1 << (CypherParser.UnescapedSymbolicName - 100))
                            | (1 << (CypherParser.EscapedSymbolicName - 100))
                        )
                    )
                    != 0
                ):
        ...
        try:
            ...
            if (
                ...
                and (
                    (1 << (_la - 53))
                    & (
                        (1 << (CypherParser.UNION - 53))
                        | (1 << (CypherParser.ALL - 53))
                        | (1 << (CypherParser.CREATE - 53))
                        | (1 << (CypherParser.DROP - 53))
                        | (1 << (CypherParser.ON - 53))
                        | (1 << (CypherParser.CONSTRAINT - 53))
                        | (1 << (CypherParser.IS - 53))
                        | (1 << (CypherParser.UNIQUE - 53))
                        | (1 << (CypherParser.EXISTS - 53))
                        | (1 << (CypherParser.WITH - 53))
                        | (1 << (CypherParser.AS - 53))
                        | (1 << (CypherParser.OPTIONAL - 53))
                        | (1 << (CypherParser.MATCH - 53))
                        | (1 << (CypherParser.UNWIND - 53))
                        | (1 << (CypherParser.MERGE - 53))
                        | (1 << (CypherParser.SET - 53))
                        | (1 << (CypherParser.DETACH - 53))
                        | (1 << (CypherParser.DELETE - 53))
                        | (1 << (CypherParser.REMOVE - 53))
                        | (1 << (CypherParser.IN - 53))
                        | (1 << (CypherParser.RETURN - 53))
                        | (1 << (CypherParser.DISTINCT - 53))
                        | (1 << (CypherParser.ORDER - 53))
                        | (1 << (CypherParser.BY - 53))
                        | (1 << (CypherParser.L_SKIP - 53))
                        | (1 << (CypherParser.LIMIT - 53))
                        | (1 << (CypherParser.ASCENDING - 53))
                        | (1 << (CypherParser.ASC - 53))
                        | (1 << (CypherParser.DESCENDING - 53))
                        | (1 << (CypherParser.DESC - 53))
                        | (1 << (CypherParser.WHERE - 53))
                        | (1 << (CypherParser.OR - 53))
                        | (1 << (CypherParser.XOR - 53))
                        | (1 << (CypherParser.AND - 53))
                        | (1 << (CypherParser.NOT - 53))
                        | (1 << (CypherParser.STARTS - 53))
                        | (1 << (CypherParser.ENDS - 53))
                        | (1 << (CypherParser.CONTAINS - 53))
                        | (1 << (CypherParser.NULL - 53))
                        | (1 << (CypherParser.COUNT - 53))
                        | (1 << (CypherParser.CASE - 53))
                        | (1 << (CypherParser.ELSE - 53))
                        | (1 << (CypherParser.END - 53))
                        | (1 << (CypherParser.WHEN - 53))
                        | (1 << (CypherParser.THEN - 53))
                        | (1 << (CypherParser.FILTER - 53))
                    )
                )
                != 0
            ) or (
                ...
                and (
                    (1 << (_la - 117))
                    & (
                        (1 << (CypherParser.EXTRACT - 117))
                        | (1 << (CypherParser.ANY - 117))
                        | (1 << (CypherParser.NONE - 117))
                        | (1 << (CypherParser.SINGLE - 117))
                        | (1 << (CypherParser.TRUE - 117))
                        | (1 << (CypherParser.FALSE - 117))
                        | (1 << (CypherParser.HexLetter - 117))
                        | (1 << (CypherParser.DO - 117))
                        | (1 << (CypherParser.FOR - 117))
                        | (1 << (CypherParser.REQUIRE - 117))
                        | (1 << (CypherParser.MANDATORY - 117))
                        | (1 << (CypherParser.SCALAR - 117))
                        | (1 << (CypherParser.OF - 117))
                        | (1 << (CypherParser.ADD - 117))
                        | (1 << (CypherParser.UnescapedSymbolicName - 117))
                        | (1 << (CypherParser.EscapedSymbolicName - 117))
                    )
                )
                != 0
            ):
            ...
            if not (
                ...
                or (
                    ...
                    and (
                        (1 << (_la - 122))
                        & (
                            (1 << (CypherParser.TRUE - 122))
                            | (1 << (CypherParser.FALSE - 122))
                            | (1 << (CypherParser.DO - 122))
                            | (1 << (CypherParser.FOR - 122))
                            | (1 << (CypherParser.REQUIRE - 122))
                            | (1 << (CypherParser.MANDATORY - 122))
                            | (1 << (CypherParser.SCALAR - 122))
                            | (1 << (CypherParser.OF - 122))
                            | (1 << (CypherParser.ADD - 122))
                        )
                    )
                    != 0
                )
