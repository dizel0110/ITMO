...
def send_email(
    subject: Any,
    message: str,
    recipients: Union[str, collections.abc.Sequence[str]],
    attachments: Optional[str] = None,
    html_message: Optional[bytes] = None,
    reply_to: Optional[collections.abc.Sequence[str]] = (),
    ...
    logger.debug('Send email to recipients: %s', recipients)
...
def get_email_body(template_path: Any, context: Any = None) -> tuple[str, str]:
